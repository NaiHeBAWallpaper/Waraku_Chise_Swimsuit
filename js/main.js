...
let customScale = 1;
let targetFps = 60;
let bgmfile = `./assets/audio/Poppin' Memories.flac`;
let bgmvolume = 0;
let bgm;
...
const AUDIO_DETAIL = [
	...
	},
	{
		time: 19000,
		count: 2,
		startTimes: [1000, 9400],
		dialog: {
			Japanese: [
				"亀さんの甲羅はね、すごく硬いんだけど～",
				"実は尻尾のところは、ふわふわしてるの。ふわふわ～って"
			],
			English: [
...
const HITBOX = {
	headpat: { xMin: 1000, xMax: 1650, yMin: 0, yMax: 300 },
	voiceline: { xMin: 1320, xMax: 2350, yMin: 730	, yMax: 1300 }
};
